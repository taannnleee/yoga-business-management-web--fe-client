...
interface LeftSideGetAllProductProps {
    setPage: React.Dispatch<React.SetStateAction<number>>;
    setTotalItems: React.Dispatch<React.SetStateAction<number>>;
}

export const LeftSideGetAllProduct: React.FC<LeftSideGetAllProductProps> = (props) => {
    ...
    // Destructure props for setPage and setTotalItems
    ...
    const handleSubCategoryClick = (category: CategoryView, subCategory: SubCategory) => {
        ...
        setPage(1); // Reset page to 1 when subcategory is clicked
        setTotalItems(1); // Reset total items to 1 when subcategory is clicked
    };
    ...
    return (
        <div className="w-64 bg-white shadow-lg p-4 space-y-4">
            {loading ? (
                ...
                <div>
                    {[...categories, { id: -1, name: 'Tất cả sản phẩm', subCategories: [] }].map((category) => (
